...
const EnhancedTask = require('../../public/src/models/EnhancedTask');
...
describe('EnhancedTask Model', () => {
    describe('Task Creation', () => {
        ...
        test('should set default values correctly', () => {
            ...
            expect(task.assigneeId).toBe(taskData.ownerId); // default assignee
        });
    });
    ...
    describe('Task Updates', () => {
        ...
        test('should update title successfully', () => {
            ...
            expect(task.updatedAt.getTime())
                .toBeGreaterThanOrEqual(oldUpdatedAt.getTime());
        });
        ...
        test('should not add duplicate tags', () => {
            ...
            expect(
                task.tags.filter(tag => tag === 'urgent')
            ).toHaveLength(1);
        });
    });
    ...
    describe('Task Serialization', () => {
        test('should serialize and deserialize correctly', () => {
            ...
            expect(restoredTask.dueDate.getTime())
                .toBe(originalTask.dueDate.getTime());
        });
    });
});
